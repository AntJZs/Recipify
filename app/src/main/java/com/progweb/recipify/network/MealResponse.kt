...
data class Meal(
    ...
    fun toRecipe(): com.progweb.recipify.datamodels.Recipe {
        ...
        for (i in ingredientFields.indices) {
            ...
            if (!ingredient.isNullOrBlank()) {
                val line = if (!measure.isNullOrBlank()) "$measure $ingredient" else ingredient
                ingredientsList.add(line)
            }
        }

        return com.progweb.recipify.datamodels.Recipe(
            name = strMeal,
            totalTimeMinutes = 25,
